...
import com.github.afezeria.hymn.common.util.Jwt
import com.github.afezeria.hymn.common.util.toClass
import com.github.afezeria.hymn.oss.OssCacheKey
...
internal class PreSignedUrlControllerTest : BaseDbTest() {
    ...
    @Test
    fun `invalid token`() {
        val url = "http://localhost:$port/module/oss/api/public/pre-signed?token=   "
