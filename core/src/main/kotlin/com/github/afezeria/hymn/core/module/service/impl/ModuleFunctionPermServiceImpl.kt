...
class ModuleFunctionPermServiceImpl : ModuleFunctionPermService {
    ...
    override fun findByFunctionApi(functionApi: String): List<ModuleFunctionPermListView> {
    ...
    override fun findViewByRoleId(roleId: String): List<ModuleFunctionPermListView> {
    ...
    override fun save(dtoList: List<ModuleFunctionPermDto>): Int {
