...
class BizObjectTypeLayoutServiceImpl : BizObjectTypeLayoutService {
    ...
    override fun findLayoutIdByRoleIdAndTypeId(roleId: String, typeId: String): String {
    ...
    override fun findViewByBizObjectId(bizObjectId: String): MutableList<BizObjectTypeLayoutListView> {
    ...
    override fun save(dtoList: List<BizObjectTypeLayoutDto>): Int {
