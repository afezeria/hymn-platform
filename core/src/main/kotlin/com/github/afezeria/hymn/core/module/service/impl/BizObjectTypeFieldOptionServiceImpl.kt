...
import com.github.afezeria.hymn.core.module.service.BizObjectTypeFieldOptionService
 ...
 */
@Service
class BizObjectTypeFieldOptionServiceImpl : BizObjectTypeFieldOptionService {
    ...
    override fun update(id: String, dto: BizObjectTypeFieldOptionDto): Int {
    ...
    override fun create(dto: BizObjectTypeFieldOptionDto): String {
        val e = dto.toEntity()
        val id = bizObjectTypeFieldOptionDao.insert(e)
        return id
    }

    override fun findAll(): MutableList<BizObjectTypeFieldOption> {
        return bizObjectTypeFieldOptionDao.selectAll()
    }


    override fun findById(id: String): BizObjectTypeFieldOption? {
        return bizObjectTypeFieldOptionDao.selectById(id)
    }

    override fun findByIds(ids: List<String>): MutableList<BizObjectTypeFieldOption> {
    ...
    override fun pageFind(pageSize: Int, pageNum: Int): List<BizObjectTypeFieldOption> {
    ...
    override fun save(dtoList: List<BizObjectTypeFieldOptionDto>): Int {
