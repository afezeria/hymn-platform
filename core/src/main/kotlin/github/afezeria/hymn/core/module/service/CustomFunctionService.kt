...
import github.afezeria.hymn.core.module.dao.CustomFunctionDao
import github.afezeria.hymn.core.module.dto.CustomFunctionDto
...
class CustomFunctionService {
    ...
    fun findById(id: String): github.afezeria.hymn.core.module.entity.CustomFunction? {
    ...
    fun findByApi(
        api: String,
    ): github.afezeria.hymn.core.module.entity.CustomFunction? {
